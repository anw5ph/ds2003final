...
* <span style="color: #FAA0A0"> **Strong Family-Community Ties Rating** </span>: This column lists the student attendance rate for each school. These rates are calculated by dividing the total number of days attended by all students by the total number of days on register for all students. Rates are given as categorical classifications of "Not Meeting Target", "Approaching Target", "Meeting Target", "Exceeding Target" which we have converted to "Low", "Medium", "High", and "Very High."
